...
import PrivacyPolicy from "@/components/PoliticasPrvacidad/Privacy-policy"

export const metadata = {
  title: "Política de Privacidad - Séntia",
  description:
    "Política de privacidad de Séntia: cómo protegemos y manejamos su información personal en nuestra plataforma de bienestar emocional.",
}
