...
export default function Footer() {
  ...
  const hideFullFooterIn = ["/", "/register", "/login", "/contact-us", "/help-centers", "/emotions", "/emotions/myEmotionalLog", "/emotions/myHistory"]; // ← aquí defines dónde NO quieres el footer completo
